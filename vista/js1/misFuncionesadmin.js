...
function consultar(){
    ...
    $.ajax({
        url:"http://129.146.198.67:8090/api/Admin/all",
        type:"GET",
        datatype:"JSON",
...
function pintarRespuesta(respuesta){
    ...
    let myTable="<table>";
	myTable+="<tr>" + "<th>NOMBRE<th>EMAIL<th>CONTRASEÑA</th>"+"</tr>";
...
function guardar(){
    let var2 = {
        ...
        $.ajax({
		url:"http://129.146.198.67:8090/api/Admin/save",
         type:'POST',
...
function actualizar(idElemento){
    ...
    $.ajax({
        url:"http://129.146.198.67:8090/api/Admin/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrar(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.146.198.67:8090/api/Admin/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
