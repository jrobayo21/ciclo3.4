...
function consultar(){
    ...
    $.ajax({
        url:"http://129.146.198.67:8090/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function guardar(){
    let var2 = {
        ...
        $.ajax({
		url:"http://129.146.198.67:8090/api/Category/save",
         type:'POST',
...
function actualizar(idElemento){
    ...
    $.ajax({
        url:"http://129.146.198.67:8090/api/Category/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrar(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.146.198.67:8090/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
