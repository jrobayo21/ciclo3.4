...
function consultar(){
    ...
    $.ajax({
        url:"http://129.146.198.67:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
...
function guardar(){
    let var2 = {
        ...
        $.ajax({
		url:"http://129.146.198.67:8080/api/Message/save",
         type:'POST',
...
function actualizar(idElemento){
    ...
    $.ajax({
        url:"http://129.146.198.67:8080/api/Message/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrar(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.146.198.67:8080/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
